    ...
    <div>
        ...
        <form class="layui-form" action="" onsubmit="return false">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" name="hobby[smoke]" value="抽烟" title="抽烟">
                    <input type="checkbox" name="hobby[drink]" value="喝酒" title="喝酒" checked="">
                    <input type="checkbox" name="hobby[hotHead]" value="烫头" title="烫头">
                </div>
            </div>
